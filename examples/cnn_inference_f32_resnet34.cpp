...
void resnet34_v2(std::vector<primitive> &net, std::vector<std::unordered_map<int, memory>> &net_args, engine &engine, stream &stream, std::map<std::string, Weights> &weightMap,
    ...
    // basicBlock3
    memory layer1_conv1_6 =  conv2d_onednn_wo_bias(layer1_relu1_5, net, net_args, engine, stream, weightMap["layer1.2.conv1.weight"].values, t_dims, 64, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer1_bn_relu1_6 = bn_onednn(layer1_conv1_6, net, net_args, engine, stream, weightMap["layer1.2.bn1.weight"].values, weightMap["layer1.2.bn1.bias"].values, weightMap["layer1.2.bn1.running_mean"].values, weightMap["layer1.2.bn1.running_var"].values, t_dims, 1.e-5f);
    layer1_bn_relu1_6 = activation_onednn(layer1_bn_relu1_6, net, net_args, engine, stream);
    memory layer1_conv1_7 = conv2d_onednn_wo_bias(layer1_bn_relu1_6, net, net_args, engine, stream, weightMap["layer1.2.conv2.weight"].values, t_dims, 64, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer1_bn7 = bn_onednn(layer1_conv1_7, net, net_args, engine, stream, weightMap["layer1.2.bn2.weight"].values, weightMap["layer1.2.bn2.bias"].values, weightMap["layer1.2.bn2.running_mean"].values, weightMap["layer1.2.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer1_elt_sum1_7 = eltwise_onednn(layer1_relu1_5, layer1_bn7, net, net_args, engine, stream);
    memory layer1_relu1_7 = activation_onednn(layer1_elt_sum1_7, net, net_args, engine, stream);
    // layer1 
	//show_dims(t_dims);
	...
	memory layer2_conv1_1 = conv2d_onednn_wo_bias(layer1_relu1_7, net, net_args, engine, stream, weightMap["layer2.0.conv1.weight"].values, t_dims, 128, 3, 3, 2, 2, 1, 1, 1, 1);
	...
	memory layer2_down_conv1_2 = conv2d_onednn_wo_bias(layer1_relu1_7, net, net_args, engine, stream, weightMap["layer2.0.downsample.0.weight"].values, t_dims2, 128, 1, 1, 2, 2, 0, 0, 0, 0);
	...
	// basicBlock3
    memory layer2_conv1_6 = conv2d_onednn_wo_bias(layer2_relu1_5, net, net_args, engine, stream, weightMap["layer2.2.conv1.weight"].values, t_dims, 128, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer2_bn_relu1_6 = bn_onednn(layer2_conv1_6, net, net_args, engine, stream, weightMap["layer2.2.bn1.weight"].values, weightMap["layer2.2.bn1.bias"].values, weightMap["layer2.2.bn1.running_mean"].values, weightMap["layer2.2.bn1.running_var"].values, t_dims, 1.e-5f);
    layer2_bn_relu1_6 = activation_onednn(layer2_bn_relu1_6, net, net_args, engine, stream);
    memory layer2_conv1_7 = conv2d_onednn_wo_bias(layer2_bn_relu1_6, net, net_args, engine, stream, weightMap["layer2.2.conv2.weight"].values, t_dims, 128, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer2_bn7 = bn_onednn(layer2_conv1_7, net, net_args, engine, stream, weightMap["layer2.2.bn2.weight"].values, weightMap["layer2.2.bn2.bias"].values, weightMap["layer2.2.bn2.running_mean"].values, weightMap["layer2.2.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer2_elt_sum1_7 = eltwise_onednn(layer2_relu1_5, layer2_bn7, net, net_args, engine, stream);
    memory layer2_relu1_7 = activation_onednn(layer2_elt_sum1_7, net, net_args, engine, stream);
    // basicBlock4
    memory layer2_conv1_8 = conv2d_onednn_wo_bias(layer2_relu1_7, net, net_args, engine, stream, weightMap["layer2.3.conv1.weight"].values, t_dims, 128, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer2_bn_relu1_8 = bn_onednn(layer2_conv1_8, net, net_args, engine, stream, weightMap["layer2.3.bn1.weight"].values, weightMap["layer2.3.bn1.bias"].values, weightMap["layer2.3.bn1.running_mean"].values, weightMap["layer2.3.bn1.running_var"].values, t_dims, 1.e-5f);
    layer2_bn_relu1_8 = activation_onednn(layer2_bn_relu1_8, net, net_args, engine, stream);
    memory layer2_conv1_9 = conv2d_onednn_wo_bias(layer2_bn_relu1_8, net, net_args, engine, stream, weightMap["layer2.3.conv2.weight"].values, t_dims, 128, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer2_bn9 = bn_onednn(layer2_conv1_9, net, net_args, engine, stream, weightMap["layer2.3.bn2.weight"].values, weightMap["layer2.3.bn2.bias"].values, weightMap["layer2.3.bn2.running_mean"].values, weightMap["layer2.3.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer2_elt_sum1_9 = eltwise_onednn(layer2_relu1_7, layer2_bn9, net, net_args, engine, stream);
	...
	// basicBlock1
	t_dims2 = t_dims;
	memory layer3_conv1_1 = conv2d_onednn_wo_bias(layer2_relu1_9, net, net_args, engine, stream, weightMap["layer3.0.conv1.weight"].values, t_dims, 256, 3, 3, 2, 2, 1, 1, 1, 1);
	...
	memory layer3_down_conv1_2 = conv2d_onednn_wo_bias(layer2_relu1_9, net, net_args, engine, stream, weightMap["layer3.0.downsample.0.weight"].values, t_dims2, 256, 1, 1, 2, 2, 0, 0, 0, 0);
	...
	// basicBlock3
    // begine
    memory layer3_conv1_6 = conv2d_onednn_wo_bias(layer3_relu1_5, net, net_args, engine, stream, weightMap["layer3.2.conv1.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn_relu1_6 = bn_onednn(layer3_conv1_6, net, net_args, engine, stream, weightMap["layer3.2.bn1.weight"].values, weightMap["layer3.2.bn1.bias"].values, weightMap["layer3.2.bn1.running_mean"].values, weightMap["layer3.2.bn1.running_var"].values, t_dims, 1.e-5f);
    layer3_bn_relu1_6 = activation_onednn(layer3_bn_relu1_6, net, net_args, engine, stream);
    memory layer3_conv1_7 = conv2d_onednn_wo_bias(layer3_bn_relu1_6, net, net_args, engine, stream, weightMap["layer3.2.conv2.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn7 = bn_onednn(layer3_conv1_7, net, net_args, engine, stream, weightMap["layer3.2.bn2.weight"].values, weightMap["layer3.2.bn2.bias"].values, weightMap["layer3.2.bn2.running_mean"].values, weightMap["layer3.2.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer3_elt_sum1_7 = eltwise_onednn(layer3_relu1_5, layer3_bn7, net, net_args, engine, stream);
    memory layer3_relu1_7 = activation_onednn(layer3_elt_sum1_7, net, net_args, engine, stream);
    // end
    // basicBlock4
    memory layer3_conv1_8 = conv2d_onednn_wo_bias(layer3_relu1_7, net, net_args, engine, stream, weightMap["layer3.3.conv1.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn_relu1_8 = bn_onednn(layer3_conv1_8, net, net_args, engine, stream, weightMap["layer3.3.bn1.weight"].values, weightMap["layer3.3.bn1.bias"].values, weightMap["layer3.3.bn1.running_mean"].values, weightMap["layer3.3.bn1.running_var"].values, t_dims, 1.e-5f);
    layer3_bn_relu1_8 = activation_onednn(layer3_bn_relu1_8, net, net_args, engine, stream);
    memory layer3_conv1_9 = conv2d_onednn_wo_bias(layer3_bn_relu1_8, net, net_args, engine, stream, weightMap["layer3.3.conv2.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn9 = bn_onednn(layer3_conv1_9, net, net_args, engine, stream, weightMap["layer3.3.bn2.weight"].values, weightMap["layer3.3.bn2.bias"].values, weightMap["layer3.3.bn2.running_mean"].values, weightMap["layer3.3.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer3_elt_sum1_9 = eltwise_onednn(layer3_relu1_7, layer3_bn9, net, net_args, engine, stream);
    memory layer3_relu1_9 = activation_onednn(layer3_elt_sum1_9, net, net_args, engine, stream);
    // basicBlock5
    memory layer3_conv1_10 = conv2d_onednn_wo_bias(layer3_relu1_9, net, net_args, engine, stream, weightMap["layer3.4.conv1.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn_relu1_10 = bn_onednn(layer3_conv1_10, net, net_args, engine, stream, weightMap["layer3.4.bn1.weight"].values, weightMap["layer3.4.bn1.bias"].values, weightMap["layer3.4.bn1.running_mean"].values, weightMap["layer3.4.bn1.running_var"].values, t_dims, 1.e-5f);
    layer3_bn_relu1_10 = activation_onednn(layer3_bn_relu1_10, net, net_args, engine, stream);
    memory layer3_conv1_11 = conv2d_onednn_wo_bias(layer3_bn_relu1_10, net, net_args, engine, stream, weightMap["layer3.4.conv2.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn11 = bn_onednn(layer3_conv1_11, net, net_args, engine, stream, weightMap["layer3.4.bn2.weight"].values, weightMap["layer3.4.bn2.bias"].values, weightMap["layer3.4.bn2.running_mean"].values, weightMap["layer3.4.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer3_elt_sum1_11 = eltwise_onednn(layer3_relu1_9, layer3_bn11, net, net_args, engine, stream);
    memory layer3_relu1_11 = activation_onednn(layer3_elt_sum1_11, net, net_args, engine, stream);
    // basicBlock6
    memory layer3_conv1_12 = conv2d_onednn_wo_bias(layer3_relu1_11, net, net_args, engine, stream, weightMap["layer3.5.conv1.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn_relu1_12 = bn_onednn(layer3_conv1_12, net, net_args, engine, stream, weightMap["layer3.5.bn1.weight"].values, weightMap["layer3.5.bn1.bias"].values, weightMap["layer3.5.bn1.running_mean"].values, weightMap["layer3.5.bn1.running_var"].values, t_dims, 1.e-5f);
    layer3_bn_relu1_12 = activation_onednn(layer3_bn_relu1_12, net, net_args, engine, stream);
    memory layer3_conv1_13 = conv2d_onednn_wo_bias(layer3_bn_relu1_12, net, net_args, engine, stream, weightMap["layer3.5.conv2.weight"].values, t_dims, 256, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer3_bn13 = bn_onednn(layer3_conv1_13, net, net_args, engine, stream, weightMap["layer3.5.bn2.weight"].values, weightMap["layer3.5.bn2.bias"].values, weightMap["layer3.5.bn2.running_mean"].values, weightMap["layer3.5.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer3_elt_sum1_13 = eltwise_onednn(layer3_relu1_11, layer3_bn13, net, net_args, engine, stream);
    memory layer3_relu1_13 = activation_onednn(layer3_elt_sum1_13, net, net_args, engine, stream);
    // layer3 
	//show_dims(t_dims);
	...
	// basicBlock1
	t_dims2 = t_dims;
	memory layer4_conv1_1 = conv2d_onednn_wo_bias(layer3_relu1_13, net, net_args, engine, stream, weightMap["layer4.0.conv1.weight"].values, t_dims, 512, 3, 3, 2, 2, 1, 1, 1, 1);
	...
	memory layer4_down_conv1_2 = conv2d_onednn_wo_bias(layer3_relu1_13, net, net_args, engine, stream, weightMap["layer4.0.downsample.0.weight"].values, t_dims2, 512, 1, 1, 2, 2, 0, 0, 0, 0);
    ...
    // basicBlock3
    memory layer4_conv1_6 = conv2d_onednn_wo_bias(layer4_relu1_5, net, net_args, engine, stream, weightMap["layer4.2.conv1.weight"].values, t_dims, 512, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer4_bn_relu1_6 = bn_onednn(layer4_conv1_6, net, net_args, engine, stream, weightMap["layer4.2.bn1.weight"].values, weightMap["layer4.2.bn1.bias"].values, weightMap["layer4.2.bn1.running_mean"].values, weightMap["layer4.2.bn1.running_var"].values, t_dims, 1.e-5f);
    layer4_bn_relu1_6 = activation_onednn(layer4_bn_relu1_6, net, net_args, engine, stream);
    memory layer4_conv1_7 = conv2d_onednn_wo_bias(layer4_bn_relu1_6, net, net_args, engine, stream, weightMap["layer4.2.conv2.weight"].values, t_dims, 512, 3, 3, 1, 1, 1, 1, 1, 1);
    memory layer4_bn7 = bn_onednn(layer4_conv1_7, net, net_args, engine, stream, weightMap["layer4.2.bn2.weight"].values, weightMap["layer4.2.bn2.bias"].values, weightMap["layer4.2.bn2.running_mean"].values, weightMap["layer4.2.bn2.running_var"].values, t_dims, 1.e-5f);
    memory layer4_elt_sum1_7 = eltwise_onednn(layer4_relu1_5, layer4_bn7, net, net_args, engine, stream);
    memory layer4_relu1_7 = activation_onednn(layer4_elt_sum1_7, net, net_args, engine, stream);
	// layer4 
	memory global_avg_pooling = gap_onednn(layer4_relu1_7, net, net_args, engine, stream, t_dims);
...
int main(int argc, char **argv) {
	...
	resnet34_v2(net, net_args, engine, stream, weightMap, batch_size, input_channel, input_height, input_width, t_dims); //100th dur time : 9078 ms - > 7019 ms
